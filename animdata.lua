...
animlist =  {
    { dict = "rcmpaparazzo_2",                                              anim = "shag_loop_a",                        name = "NSFW: Hit It From The Back 01",         flag = 47, type = 7, boneID = 0, pedType = "PED_TYPE_PROSTITUTE", pedHash = 1846523796, posx = 0.0,  posy = 0.2, posz = 0.0,  rotx  = 40.0, roty = 0.0, rotz = 0.0,   dict2 = "rcmpaparazzo_2",       anim2 = "shag_loop_poppy", sfx = "SEX_GENERIC_FEM", sfxFlg = "SPEECH_PARAMS_FORCE"},
    ...
    { dict = "ragdoll@human",                                               anim = "on_fire",                            name = "Movement: Ragdoll (on fire)",           flag = 02, ptfxdict = "core",                ptfxname = "fire_wrecked_tank",         ptfxdelay = 69,  ptfxscale = 0.69420, ptfxOffx = 0.0, ptfxOffy = 0.0,       ptfxOffz = -0.0069420, ptfxrotx = 0.0, ptfxroty = 0.0,  ptfxrotz = 0.0,  type = 2},
    ...
    { dict = "timetable@tracy@sleep@",                                      anim = "idle_b",                             name = "MISC: Sleep",                           flag = 33, prop1 = 3314781611, boneID = 0,     posx = 0.0,       posy = 0.0,       posz = 0.0,    rotx = 0.0,   roty = 0.0,        rotz = 0.0,      type = 4, propColl = true},
